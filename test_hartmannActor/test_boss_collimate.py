...
b1 = boss_collimate.OneCamResult('b1', True, xshift, b1coeff, 30, -0.5, -2157, None)
r1 = boss_collimate.OneCamResult('r1', True, xshift, r1coeff, 34, -0.3, -1921, None)
b2 = boss_collimate.OneCamResult('b2', True, xshift, b2coeff, 48, 0.4, 903, None)
r2 = boss_collimate.OneCamResult('r2', True, xshift, r2coeff, 50, 0.5, 3638, None)
